...
export default function CategoriaAdminRow({ categoria }) {
    ...
    return (
        <tr className={`border text-black odd:bg-gray-100 even:bg-white`}>
            ...
            <td className="align-middle">{categoria?.title}</td>
            ...
            <td className="flex h-[90px] items-center justify-center">
                <Switch status={categoria?.featured == 1} id={categoria?.id} routeName={'admin.categorias.changeFeatured'} />
            </td>
