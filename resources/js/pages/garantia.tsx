    ...
    return (
        <DefaultLayout>
            ...
            >
                ...
                <h2 className="absolute z-10 mx-auto w-[1200px] pb-20 text-3xl font-bold text-white sm:text-4xl">Garantia</h2>
            </div>

            <div className="mx-auto my-20 flex h-[564px] w-[1200px] flex-row gap-10">
