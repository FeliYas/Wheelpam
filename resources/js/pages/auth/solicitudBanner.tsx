...
export default function SolicitudBanner() {
    const { solicitudBanner } = usePage().props;
                ...
                <div className="col-span-2 w-full">
                    ...
                    <div className="mt-2 flex justify-between rounded-lg border shadow-lg">
                        <div className="h-[200px] w-2/3 bg-[rgba(0,0,0,0.2)]">
                            <img className="h-full w-full rounded-md object-cover" src={solicitudBanner?.image} alt="" />
                        </div>
