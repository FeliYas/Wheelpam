...
export default function Nosotros() {
    ...
    return (
        <DefaultLayout>
            ...
            >
                <div className="absolute top-16 z-40 mx-auto w-full max-w-[1200px] px-4 text-[12px] text-white max-sm:block sm:top-10 md:top-10 lg:px-0">
                ...
                <h2 className="absolute z-10 mx-auto w-[1200px] pb-20 text-3xl font-bold text-white max-sm:max-w-[1200px] sm:text-4xl">Servicios</h2>
            </div>

            <div className="mx-auto flex w-[1200px] flex-row gap-5 py-20 max-sm:w-full max-sm:flex-col max-sm:items-center">
